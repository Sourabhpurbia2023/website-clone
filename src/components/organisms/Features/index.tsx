...
const featureTabs = [
  {
    ...
    imageSrc: '/assets-feature-tabs/lead-management-v3.png',
    mediaType: 'image',
    icon: UserRoundPlus,
    accent: '#2563eb',
  ...
  },
  {
    ...
    imageSrc: '/assets-feature-tabs/invoicing-v2-refresh.png',
    mediaType: 'image',
    icon: ReceiptText,
    accent: '#0f766e',
  ...
  },
  {
    ...
    imageSrc: '/assets-feature-tabs/document-vault-v2-refresh.png',
    mediaType: 'image',
    icon: FolderLock,
    accent: '#2563eb',
